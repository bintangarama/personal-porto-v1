...
import {
  HiExternalLink, HiCode, HiAcademicCap, HiDatabase,
  HiTerminal, HiChartBar,
} from 'react-icons/hi';
  ...
  const featuredProjects = [
    {
      ...
      title: lang === 'id' ? 'sistem inventaris stokita' : 'stokita inventory system',
      desc:
        lang === 'id'
      ...
      live: 'https://github.com/bintangarama/stokita',
    ...
    {
      num: '02',
      tag: lang === 'id' ? 'FINANSIAL & PYTHON' : 'FINANCIAL & PYTHON',
      title: lang === 'id' ? 'martabak finance tracker' : 'martabak finance tracker',
      desc:
        lang === 'id'
      ...
      tech: 'Python · SQLite',
      live: 'https://github.com/bintangarama/martabak-finance-tracker',
    ...
    {
      num: '03',
      tag: lang === 'id' ? 'SISTEM PENDUKUNG KEPUTUSAN' : 'DECISION SUPPORT SYSTEM',
      title: lang === 'id' ? 'spk evaluasi restoran' : 'restaurant dss (fuzzy ahp)',
      desc:
        lang === 'id'
      ...
      live: 'https://github.com/bintangarama/Sistem-Evaluasi-dan-Analisis-Pelayanan-Restoran',
      github: 'https://github.com/bintangarama/Sistem-Evaluasi-dan-Analisis-Pelayanan-Restoran',
      widget: (
        <div className="p-screenshot-wrap">
          <img
      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <h2 className="section-title">
            {lang === 'id'
              ? <>Membangun solusi secara <span className="text-italic-accent">presisi</span></>
              : <>Building solutions with <span className="text-italic-accent">precision</span></>}
          </h2>
        ...
        <div className="projects__tabs" role="tablist">
          {tabs.map(tab => (
            ...
            >
              {tab.key === 'web' ? <HiCode size={14} /> : <HiChartBar size={14} />}
              {tab.label}
            </button>
          ))}
        </div>
              ...
              >
                {featuredProjects.map((project) => (
                  <motion.div
                    ...
                    whileHover={{ y: -6 }}
                  >
                    <span className="p-card-eyebrow mono-label">{project.num}</span>
                    <span className="p-card-tag font-mono-sub">{project.tag}</span>
                    ...
                    <div className="p-card-widget-container">{project.widget}</div>
                ...
                {dataProjects.map((project) => (
                  ...
                  >
                    <div className="data-card__top">
                      <span className="data-card__icon"><HiChartBar size={18} /></span>
        ...
        <div className="projects__cta-block">
          <a href="https://github.com/bintangarama" target="_blank" rel="noopener noreferrer"
